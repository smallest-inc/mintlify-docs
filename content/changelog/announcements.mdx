...
<Update label="December 2024">
    ...
    Experience the new capabilities of Lightning Large via our [Platform](https://waves.smallest.ai) or the [API](content/api-references/waves-api).
</Update>
...
<Update label="November 2024">
    ...
    The voices available on waves platform are available via the [Waves API](content/api-references/waves-api)
</Update> 
...
<Update label="October 2024">
    ...
    You can access lightning via the [Waves API](content/api-references/waves-api)
</Update>
