...
1. **DD/MM/YYYY** → `12/02/2025`  
2. **DD-MM-YYYY** → `12-02-2025`  
3. **DD Month YYYY** → `12 February 2025`  
4. **Month DD YYYY** → `February 12 2025`  
5. **DD-MM-YY** → `12-02-25`  
6. **DD/MM/YY** → `12/02/25`  
...
**Examples of Incorrect Date Usage:**  
❌ **21st of June, 2003**. (Incorrect because "of" is not allowed)  
❌ **12.02.2025**. (Incorrect because dots are not an allowed separator)  
...
Examples of Correct Time Usage:
...
Examples of Incorrect Time Usage:
❌ **14.30** (Incorrect because dots are not an allowed separator)  
❌ **7:5 AM** (Incorrect because the minute value must always be two digits) 
