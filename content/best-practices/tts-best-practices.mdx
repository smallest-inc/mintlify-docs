...
3. DD Month YYYY → `12 February 2025` → "12 February twenty-twenty five"
4. Month DD YYYY → `February 12th 2025` → "February twelveth twenty-twenty five"
5. DD-MM-YY → `12-02-25` → "twelve two twenty-five"
6. DD/MM/YY → `12/02/25` → "twelve two twenry-five"
